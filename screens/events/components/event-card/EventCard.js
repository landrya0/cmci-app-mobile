...
import RippleButton from 'cmci-app-mobile/components/RippleButton';
    ...
    return (
      <View style={styles.card}>
        ...
        <View style={styles.cardBody}>
          <PSText type='Italic' style={styles.subtitle} size={12}>{this.props.data.datetime + '  -  ' + this.props.data.town}</PSText>
          <PSText type='Bold' style={styles.title} size={22}>{this.props.data.title}</PSText>
        </View>
